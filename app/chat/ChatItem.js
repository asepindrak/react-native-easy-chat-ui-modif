  ...
  _matchContentString = (textContent, views, isSelf) => {
    ...
    if (emojiIndex === -1) {
      views.push(
        <Text
          style={[
            isSelf ? rightMessageTextStyle : leftMessageTextStyle,
            isSelf ? { color: "#fff" } : {},
          ]}
    ...
    switch (type) {
      ...
      case "image":
        if (this.props.renderImageMessage === undefined) {
          ...
          return this.props.renderImageMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case "voice":
        if (this.props.renderVoiceMessage === undefined) {
          ...
          return this.props.renderVoiceMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case "video":
        if (this.props.renderVideoMessage === undefined) {
          ...
          return this.props.renderVideoMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case "share":
        if (this.props.renderShareMessage === undefined) {
          ...
          return this.props.renderShareMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case "file":
        if (this.props.renderFileMessage === undefined) {
          ...
          return this.props.renderFileMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case "pat":
        if (this.props.renderPatMessage === undefined) {
          ...
          return this.props.renderPatMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case "custom":
        if (this.props.renderCustomMessage === undefined) {
          ...
          return this.props.renderCustomMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case "system":
        if (this.props.renderSystemMessage === undefined) {
          ...
          return this.props.renderSystemMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
            ...
            >
              ...
              {type === "system" ? null : (
                <TouchableOpacity
                  ...
                  disabled={isOpen}
                  onPress={() =>
                    this.props.onPressAvatar(isSelf, message.targetId)
                  }
                >
              ...
              <View
                style={[
                  {
                    justifyContent:
                      showName && type === "voice" ? "flex-start" : "center",
                  },
                  type === "system" && { flex: 1 },
                ]}
              >
